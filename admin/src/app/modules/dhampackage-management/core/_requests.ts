...
const MODEL_URL = `${API_URL}/dham_package`
...
const createModel = (model: FormData): Promise<ModelQueryResponse | undefined> => {
  return axios
...
const updateModel = (model: FormData, id:ID): Promise<ModelQueryResponse> => {
  return axios
