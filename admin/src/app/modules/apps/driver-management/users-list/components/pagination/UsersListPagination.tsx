...
// import { CustomSelect } from '../../../users-add/select-react/CustomSelect'
...
//     updateState({page, items_per_page: pagination.items_per_page || 15})
//   }
//   // type direction = keyof typeof pagination.items_per_page; 
//   // console.log(direction);
//   // type LogLevelStrings = keyof typeof LogLevel;
// const no_of_record =pagination.items_per_pages
// // {no_of_record?.map((Obj)=>{
// //   console.log(Obj )
// // })

// // } 
// // console.log("pagination.links start");
// //  console.log(pagination.items_per_pages);
// //  console.log("pagination.links end");
...
//         <select className="form-select form-select-solid w-100px" onChange={(event:any) => {updateState({items_per_page: event.target.value});
//         updatePage(1)
//          console.log(event.target.value)}} name='items_per_page'>
...
//         </select>
//         {/* <CustomSelect
//           options={no_of_record?.map((rolesObj:number) => { return { 'label': rolesObj, 'value': rolesObj } })}
//           value={pagination.items_per_page}
//           className={'form-control-solid mb-3 mb-lg-0'}
//           onChange={(value: any) => { updateState({items_per_page: value.target.value}); }}
//         />  */}
//       </div>
...
//                     })}
//                     onClick={() => {updatePage(link.page); console.log("link.page" +link.page)}}
