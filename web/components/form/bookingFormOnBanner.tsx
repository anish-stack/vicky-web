...
interface BookingFormOnBannerProps {
    Title: string
    subTitle: string
    buttonName: string
}

const BookingFormOnBanner: React.FC<BookingFormOnBannerProps> = ({
    Title,
    subTitle,
    buttonName,
}) => {
    ...
    const calculateDistance = async () => {
        ...
        try {
            const response = await fetch(
                `/api/radar/distance?origins=${startOption.latitude},${startOption.longitude}&destinations=${endOption.latitude},${endOption.longitude}`
            );
            const data = await response.json();

            if (data.routes.car.distance.text) {
                setDistance(data.routes.car.distance.text);
            } else {
                            ...
                            <div className="booking-form">
                                ...
                                <form method="get" action="#">
                                    <div className="row gx-3">
                                        ...
                                        {startOption && endOption && (
                                            <>
                                                <div className='form-group col-lg-6 col-md-12 co-sm-12 mt-3 mt-sm-0'>
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 mt-3 mt-sm-0">
                                            <button
                                                type="submit"
...
export default BookingFormOnBanner;
