...
const staticTestimonials = [
  {
    name: "Priya Sharma",
    location: "Delhi",
    text: "Premium fleet, spotless car, and the driver was extremely professional.",
    rating: 5,
    avatar: avatarPool[0],
  },
  {
    name: "Rajesh Kumar",
    location: "Gurgaon",
    text: "Best rental experience — smooth booking and punctual pickup every time.",
    rating: 5,
    avatar: avatarPool[1],
  },
  {
    name: "Anita Patel",
    location: "Noida",
    text: "Comfortable long-distance trip with a courteous, safe driver.",
    rating: 5,
    avatar: avatarPool[2],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Real experiences from happy customers renting premium vehicles.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center">
                <img
                  src={item.avatar}
                  alt={item.name}
                  className="w-12 h-12 rounded-full object-cover mr-3 ring-2 ring-orange-100"
                />
                <div>
